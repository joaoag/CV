...
|[Event Planner (SPA)](https://github.com/joaoag/event_planner_spa_js) | 4 days | Only the second week of using javascript so quite happy with being able to implement local storage and get my app talking to a weather API. | Javascript, HTML, CSS</br> Tested with Jasmine and my custom testing framework |
